...
public class result extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if ((discriminant > 0)) {
            if (a > 0) {
                iv.setImageResource(R.drawable.pi1);
            } else {
                iv.setImageResource(R.drawable.pi2);
            }
            solutionTextView.setText("Root 1: " + root1 + "\nRoot 2: " + root2);
        } else if (discriminant == 0) {
            if (a > 0) {
                iv.setImageResource(R.drawable.pi3);
            } else {
                iv.setImageResource(R.drawable.pi4);
            }
            solutionTextView.setText("Root 1: " + root1);

        } else {
            if (a > 0) {
                iv.setImageResource(R.drawable.pi5);
            } else {
                iv.setImageResource(R.drawable.pi6);
            }
